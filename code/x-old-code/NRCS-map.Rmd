...
derived from: Jared Kibele and Jeanette Clark. 2018. State of Alaska’s Salmon and People Regional Boundaries. Knowledge Network for Biocomplexity. doi:10.5063/F1125QWP.
...
ak_map_fig =
  ggplot()+
  geom_sf(data = ak_regions_3338, aes(), fill = "#b0c4b1")+
    geom_sf(data = gps_joined, aes(x = lat, y = lng), shape = 21, fill = "#ffb703", size = 3)+
...
ggsave("output/ak_map_fig_nrcs.png", plot = ak_map_fig, height = 12, width = 12)
